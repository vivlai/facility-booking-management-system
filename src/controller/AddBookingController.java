...
public class AddBookingController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Date startDate = DateUtil.convertStringToDate( request.getParameter("startDate") );
		Date endDate = DateUtil.convertStringToDate( request.getParameter("endDate") );
		...
		for (String email : personEmails) {
			// to-do: check if person exists before adding
		...
		Booking booking = new Booking(/*autogenerated*/ -1, startDate, endDate, persons, location);
